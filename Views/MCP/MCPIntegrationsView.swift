...
struct MCPIntegrationsView: View {
    /// [T-mcp-oauth-deeplink] When set (ze://settings/mcp-servers/<id>),
    ...
    var body: some View {
        ...
        // server written by ze-mcp-cli after launch shows up without an app
...
/// refresh (`ze-mcp-cli refresh <name>`: evict the daemon session,
