...
/// its own running / success / failure state. All prompts are short + Ze-themed.
...
final class TestSession: ObservableObject {
    ...
    private static func performTest(_ kind: ModelQuickTestSheet.Kind, entry: ModelEntry) async throws -> TestRun.State {
        ...
        case .text:
            ...
            let messages = [LLMMessage(
                role: .user,
                content: "Hi! I'm setting you up in Ze. Say hello back in one short, friendly sentence.")]
        ...
        case .imageGen:
            ...
            let resp = try await openAI.generateImage(
                prompt: "A friendly cute mascot logo for an app called Ze, minimalist, centered, soft colors",
        ...
        case .speechOut:
            ...
            let req = VoiceOutputRequest(
                input: "Hi! This is Ze testing text to speech.",
        ...
        case .transcription:
            ...
            let spoken = "Hello from Ze, testing speech to text."
    ...
    private static func makeWAV(from buffers: [AVAudioPCMBuffer]) throws -> Data {
        ...
        let tmpURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("ze-quicktest-\(UUID().uuidString).wav")
        do {
