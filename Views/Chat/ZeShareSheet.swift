...
//  to share ze:// files, images, audio, video, links, and previews.
...
struct ZeShareSheet: UIViewControllerRepresentable {
    let url: URL
    ...
    /// (`Ze-2026-05-18-205557.ips`): `SHKItemIsPDF` →
    ...
    /// other schemes (ze://, file:// with no path, etc.) return
