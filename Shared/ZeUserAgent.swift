...
///
/// Without an explicit header, URLSession sends `Ze/<CFBundleVersion>
/// CFNetwork/… Darwin/…` — i.e. the **build number** (e.g. `Ze/1`), not the
...
enum ZeUserAgent {
    ...
    static var `default`: String {
        ...
        let ua = "Ze/\(version) (iOS \(osVersion); \(model))"
        cached = ua
        return ua
    }
}
