...
enum AudioTogglePlaybackBridge {
    ...
    static let darwinNotificationName = "com.ze.app.liveActivity.audioToggle"
}
...
struct AudioTogglePlaybackIntent: LiveActivityIntent {
    ...
    static var description = IntentDescription("Toggles play/pause on Ze audio narration from the Live Activity.")
