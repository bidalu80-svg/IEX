...
enum ProviderMigration {
    ...
    private static let migrationKey = "com.ze.app.provider-migration-v1-done"
    private static let oauthMigrationKey = "com.ze.app.provider-migration-oauth-v2-done"
    ...
    private static func migrate(store: ProviderConfigStore) {
        ...
        // API Key
        if let key = readLegacyKeychain(service: "com.ze.app.anthropic-api-key") {
        ...
        // API Key
        if let key = readLegacyKeychain(service: "com.ze.app.gemini-api-key") {
            let instance = ProviderInstance(
        ...
        // API Key
        if let key = readLegacyKeychain(service: "com.ze.app.openai-api-key") {
            let instance = ProviderInstance(
    ...
    private static func loadLegacyAgentModelSettings() -> LegacyAgentModelSettings {
        let key = "com.ze.app.agent-model-settings"
    ...
    private static func isLegacyActiveProvider(_ rawValue: String) -> Bool {
        let query: [String: Any] = [
            kSecClass as String: kSecClassGenericPassword,
            kSecAttrService as String: "com.ze.app.active-provider",
