...
final class GeminiOAuthManager: NSObject, ObservableObject {
    ...
    static let legacyKeychainService = "com.ze.app.gemini-oauth"
    static let legacyKeychainAccount = "token"
    static let legacyEmailKey = "com.ze.app.gemini-email"
    static let legacyProjectIDKey = "com.ze.app.gemini-gcp-project"
