#!/usr/bin/env python3
"""daemon.py — the forked, long-lived background process behind ze-mcp-cli.
...
import sys
sys.path.insert(0, "/usr/local/lib/ze-mcp-cli")
...
class MCPServerProcess:
    ...
    def _handshake(self):
        # Startup/handshake timeout is per-server configurable (Ze config,
        ...
        try:
            self._rpc("initialize", {
                ...
                "capabilities": {},
                "clientInfo": {"name": "ze-mcp-cli", "version": "1.0.0"},
            }, timeout=timeout)
