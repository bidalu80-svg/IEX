...
struct FollowUpSessionIntent: AppIntent {
    ...
    static var description = IntentDescription("Sends a follow-up prompt to an existing Ze session, continuing the conversation with the AI agent.")
