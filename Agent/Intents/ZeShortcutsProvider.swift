...
/// Siri trigger phrases (zh-Hans/zh-Hant, e.g. "问问Ze") live in
...
@available(iOS 17.0, *)
struct ZeShortcutsProvider: AppShortcutsProvider {
    static var appShortcuts: [AppShortcut] {
        // Siri-facing "ask Ze" entry — opens the app and lands in the
