...
/// Sends a prompt to the Ze AI agent and returns immediately with structured session info.
...
struct SendPromptIntent: AppIntent {
    ...
    static var description = IntentDescription("Sends a prompt to the Ze AI agent. Returns session info immediately while the task runs in the background.")
