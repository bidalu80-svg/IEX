...
final class BackgroundKeepAliveManager: NSObject, ObservableObject, CLLocationManagerDelegate {
    ...
    /// Ze briefly foregrounds → immediately backgrounds again), stopping the
    ...
    func setup() {
        ...
        // entry clears the badge in `ZeApp.handleScenePhaseChange`.
        Publishers.CombineLatest(
            SessionActivityTracker.shared.$activeSessions,
    ...
    /// clear the badge separately in `ZeApp.handleScenePhaseChange`.
