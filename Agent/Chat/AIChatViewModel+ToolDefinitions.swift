        ...
        var tools: [AgentToolDefinition] = [
            ...
            AgentToolDefinition(
                ...
                parameters: [
                    ...
                    "path": AgentToolParam(type: .string, description: "Absolute Linux path to read (e.g. /var/ze/workspace/data.csv)"),
