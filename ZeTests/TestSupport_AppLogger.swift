...
//
// The ZeTests target compiles a few production sources directly (ContextPolicy,
...
// ZeTests synchronized folder, so it is compiled ONLY into the test bundle and
