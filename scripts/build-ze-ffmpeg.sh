...
# Keep downloaded source and generated frameworks outside the checkout. The
# caller provides this directory after staging Ze's vendored inputs there.
SCRIPT_DIR="${ZE_NATIVE_WORKDIR:?ZE_NATIVE_WORKDIR must point to a writable build directory}"
